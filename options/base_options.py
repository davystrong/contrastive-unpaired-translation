...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--normG', type=str, default='instance', choices=['instance', 'tracking_instance', 'batch', 'none'], help='instance normalization or batch normalization for G')
        parser.add_argument('--normD', type=str, default='instance', choices=['instance', 'tracking_instance', 'batch', 'none'], help='instance normalization or batch normalization for D')
